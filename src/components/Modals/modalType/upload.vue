		...
		<div id="main">
			<form id="form">
				...
				<span id="note">
					...
					<span>Glisser-déposer vos musiques</span>
				</span>
...
export default {
	...
	methods:{
		...
		showFiles : function()
		{
			if(!this.musics || !this.musics.length){return "Pas de musiques séléctionnées"}
			var s = "";
...
#upload-modal{
	...
	#main{
		...
		form{
			...
			border-radius: 5px;
			#files{position: absolute;width: 100%;height: 100%;opacity: 0;z-index: 1;}
			#note{
				z-index: -1;
				position: absolute;
				display: flex;
	...
	#bottom{
		...
		#saveBtn{border: solid rgb(58, 212, 65) 1px; &:hover{background-color: rgb(58, 212, 65);}}
		#cancelBtn{border: solid crimson 1px; &:hover{background-color: crimson;}}
	}
}
