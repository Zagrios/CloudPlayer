	...
	<div id="profil-page">
		...
		<div id="infos">
			...
			<div class="input-wrapper hidden" v-bind:class="{close2: !passwordHasChange(), open2:passwordHasChange()}">
				...
				<input id="edit-password" type="password" placeholder="Ancien mot de passe" v-model="previousPassword"/>
...
export default {
	...
	methods:{
		...
		passwordHasChange:function(){ return this.validPassword(this.previousPassword) && this.newPassword == this.newPasswordCfrm && this.validPassword(this.newPassword)},
